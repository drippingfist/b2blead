...
-- Grant execute permissions to anon (in case needed)
...
GRANT EXECUTE ON FUNCTION public.can_manage_bot_user(UUID, TEXT) TO anon;
...
BEGIN
    ...
    RAISE NOTICE '- is_admin_for_bot(text)';
    RAISE NOTICE '- get_user_accessible_bots()';
    RAISE NOTICE '- can_manage_bot_user(uuid, text)';
END $$;
