...
interface ThreadsViewProps {
  ...
  dateFilter?: "today" | "last7days" | "last30days" | "last90days" | "alltime"
  onDateFilterChange?: (filter: "today" | "last7days" | "last30days" | "last90days" | "alltime") => void
  currentPage?: number
  totalThreads?: number
...
export default function ThreadsView({
  ...
  const startItem = currentPage * threadsPerPage + 1
  const endItem = Math.min((currentPage + 1) * threadsPerPage, totalThreads)
